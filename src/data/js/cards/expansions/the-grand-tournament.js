export const theGrandTournament = [
  ...
  },
  {
    ...
    set: 4,
    rating: 4,
    text: 'Choose One - Transform into a 2/1 with Charge; or a 3/2 with Stealth.',
    type: 'MINION',
    race: ' ',
    extra: ['FAST'],
    imageUrl: '22307.png',
  ...
  },
  {
    ...
    set: 4,
    rating: 4,
    text: 'Battlecry: Reveal a minion in each deck. If yours costs more, +1 Durability.',
    type: 'WEAPON',
    extra: ['SMALL_REMOVAL', 'DAMAGE', 'FAST'],
    imageUrl: '22316.png',
    tile: 'AT_077.png',
        ...
        priorities: [
          {
            ...
            filters: [
              ...
              },
              {
                property: 'name',
                operation: 'NOT_INCLUDED_IN',
                minValue: ['Eater of Secrets', 'Kezan Mystic', 'Chief Inspector'],
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    set: 4,
    rating: 2,
    text: "Taunt Deathrattle: If you're holding a Dragon, deal 3 damage to all minions.",
    type: 'MINION',
    extra: ['GENERAL'],
    imageUrl: '22353.png',
    tile: 'AT_123.png',

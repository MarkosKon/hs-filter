export const oneNightInKarazhan = [
  ...
  },
  {
    ...
    set: 7,
    rating: 4,
    text: "Battlecry: Add a random class card to your hand <i>(from your opponent's class).</i>",
    type: 'MINION',
    extra: ['FAST'],
    imageUrl: '42046.png',
    tile: 'KAR_069.png',
  },
  {
    ...
    set: 7,
    rating: 3,
    text: "Battlecry: If you're holding any non-Rogue class cards,  reduce their Cost by (2).",
    type: 'MINION',
    race: ' ',
    extra: ['TEMPO', 'FAST'],
    imageUrl: '42023.png',

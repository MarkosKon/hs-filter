export const theBoomsdayProject = [
  ...
  },
  {
    ...
    text: 'Battlecry: Give a friendly Mech +1/+1. If it has Deathrattle, trigger it.',
    type: 'MINION',
    set: 13,
    rating: 2,
    activeVersion: 0,
  ...
  },
  {
    ...
    cost: 1,
    dbfId: 47887,
    flavor: 'Step 1: Grow giant evil strawberry. Step 2: ???? Step 3: Rule Azeroth!',
    id: 'BOT_054',
  ...
  },
  {
    ...
    race: 'MECHANICAL',
    rarity: 'RARE',
    text: 'Magnetic At the end of your turn, deal 1 damage to all other characters.',
    type: 'MINION',
    set: 13,
    rating: 2,
    activeVersion: 0,
  ...
  },
  {
    ...
    name: 'Omega Medic',
    rarity: 'RARE',
    text: 'Battlecry: If you have 10 Mana Crystals, restore #10 Health to your hero.',
    type: 'MINION',
    set: 13,
    rating: 2,
    extra: ['FAST', 'HEAL'],
  ...
  },
  {
    ...
    rarity: 'RARE',
    text: "Give a minion +2/+2. Add 'More Arms!' to your hand that gives +2/+2.",
    type: 'SPELL',
    set: 13,
    rating: 2,
    extra: ['BUFF'],
  ...
  },
  {
    ...
    race: 'DEMON',
    rarity: 'RARE',
    text: 'Battlecry: Gain +1 Attack for each damage your hero has taken this turn.',
    type: 'MINION',
    set: 13,
    rating: 2,
    activeVersion: 0,
  ...
  },
  {
    ...
    health: 8,
    id: 'BOT_237',
    mechanics: ['CANT_BE_TARGETED_BY_SPELLS', 'CANT_BE_TARGETED_BY_HERO_POWERS', 'MODULAR'],
  ...
  },
  {
    ...
    text: 'Battlecry: Discover a Deathrattle minion. Also gain its Deathrattle.',
    type: 'MINION',
    set: 13,
    rating: 2,
    extra: ['VALUE'],
  ...
  },
  {
    ...
    playRequirements: { REQ_NUM_MINION_SLOTS: 1 },
    rarity: 'EPIC',
    text: 'Summon two random $2-Cost minions <i>(improved by Spell Damage)</i>.',
    type: 'SPELL',
    set: 13,
    rating: 2,
    activeVersion: 0,
  ...
  },
  {
    ...
    name: 'Astromancer',
    rarity: 'EPIC',
    text: 'Battlecry: Summon a random minion with Cost equal to your hand size.',
    type: 'MINION',
    set: 13,
    rating: 2,
    activeVersion: 0,
  ...
  },
  {
    ...
    race: 'MECHANICAL',
    rarity: 'RARE',
    text: 'Battlecry: Gain +2/+2 for each other Pogo-Hopper you played this game.',
    type: 'MINION',
    set: 13,
    rating: 2,
    activeVersion: 0,
  ...
  },
  {
    ...
    dbfId: 48837,
    elite: true,
    flavor: "How much gloop could Floop's Gloop gloop if Floop's Gloop could gloop gloop?",
    id: 'BOT_444',
  ...
  },
  {
    ...
    name: 'Omega Agent',
    rarity: 'EPIC',
    text: 'Battlecry: If you have 10 Mana Crystals, summon  2 copies of this minion.',
    type: 'MINION',
    set: 13,
    rating: 1,
    extra: ['GENERAL'],
  ...
  },
  {
    ...
    race: 'BEAST',
    rarity: 'EPIC',
    text: 'Battlecry: Deal 6 damage randomly split among other friendly minions.',
    type: 'MINION',
    set: 13,
    rating: 1,
    extra: ['TEMPO', 'FAST'],
  ...
  },
  {
    ...
    name: 'Star Aligner',
    rarity: 'EPIC',
    text: 'Battlecry: If you control 3 minions with 7 Health, deal 7 damage to all enemies.',
    type: 'MINION',
    set: 13,
    rating: 2,
    extra: ['GENERAL'],
  ...
  },
  {
    ...
    cost: 4,
    dbfId: 49045,
    flavor: 'INGREDIENTS: STAR-STUFF,  BLUE #1, NATURAL AND ARTIFICIAL FLAVORS.',
    health: 3,
    id: 'BOT_604',

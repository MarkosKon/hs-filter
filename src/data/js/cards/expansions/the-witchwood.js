export const theWitchwood = [
  ...
  },
  {
    ...
    tile: 'GIL_128.png',
    text: 'Battlecry: Double the Attack and Health of all minions in your hand.',
    type: 'MINION',
    activeVersion: 0,
    versions: [
      {
  ...
  },
  {
    ...
    tile: 'GIL_152.png',
    text: "Can't attack. Whenever this minion takes damage, deal 3 damage to a random enemy.",
    type: 'MINION',
    activeVersion: 0,
    versions: [
      {
  ...
  },
  {
    ...
    tile: 'GIL_202.png',
    text: 'Divine Shield, Rush Each turn this is in your hand, swap its Attack and Health.',
    type: 'MINION',
  },
  {
  ...
  },
  {
    ...
    tile: 'GIL_586.png',
    text: "Give a minion +2/+2. If it's an Elemental, add a random Elemental to your hand.",
    type: 'SPELL',
    activeVersion: 0,
    versions: [
      {
  ...
  },
  {
    ...
    tile: 'GIL_622.png',
    text: 'Battlecry: Deal 3 damage to the enemy hero. Restore 3 Health to your hero.',
    type: 'MINION',
  },
  {
  ...
  },
  {
    ...
    tile: 'GIL_624.png',
    text: 'Battlecry: If this is the only minion in the battlefield, gain +3/+3.',
    type: 'MINION',
  },
  {
    artist: 'Andrew Hou',
  ...
  },
  {
    ...
    tile: 'GIL_672.png',
    text: 'Lifesteal Whenever you play a card from another class, gain +1 Durability.',
    type: 'WEAPON',
    activeVersion: 0,
    versions: [
      {
  ...
  },
  {
    ...
    tile: 'GIL_681.png',
    text: '<i>This is an Elemental, Mech, Demon, Murloc, Dragon, Beast, Pirate and Totem.</i>',
    type: 'MINION',
  },
  {
    artist: 'Pior Oberson',
  ...
  },
  {
    ...
    tile: 'GIL_696.png',
    text: "Echo Add a random card to your hand <i>(from your opponent's class).</i>",
    type: 'SPELL',
  },
  {
    artist: 'Glenn Rane',
  ...
  },
  {
    ...
    tile: 'GIL_827.png',
    text: "Battlecry: Add a random card to your hand <i>(from your opponent's class).</i>",
    type: 'MINION',
  },
  {

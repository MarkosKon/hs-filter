export const rastakhansRumble = [
  ...
  },
  {
    ...
    rarity: 'LEGENDARY',
    set: 14,
    text: "Battlecry: Cast all spells you've played this game <i>(targets chosen randomly)</i>.",
    type: 'HERO',
    rating: 3,
    extra: ['VALUE'],
  ...
  },
  {
    ...
    rarity: 'LEGENDARY',
    set: 14,
    text: 'Whenever you target a minion with a spell, it also targets adjacent ones.',
    type: 'MINION',
    rating: 4,
    extra: ['GENERAL'],
  ...
  },
  {
    ...
    dbfId: 50009,
    elite: true,
    flavor: 'With Griftah in your deck, sometimes you start the game with The Coin!',
    health: 5,
    id: 'TRL_096',
    mechanics: ['BATTLECRY'],
    name: 'Griftah',
  ...
  },
  {
    ...
    cost: 2,
    dbfId: 50278,
    flavor: "“The spirits spoke to me.” 'What did they say?' 'You had lethal two turns ago.'",
    id: 'TRL_097',
    name: 'Seance',
  ...
  },
  {
    ...
    rarity: 'RARE',
    set: 14,
    text: 'Stealth for 1 turn. After your hero attacks and   kills a minion, draw a card.  ',
    type: 'MINION',
    rating: 1,
    extra: ['GENERAL'],
  ...
  },
  {
    ...
    text: "Battlecry: Deal damage to an enemy minion equal to your hero's Attack.",
    type: 'MINION',
    rating: 2,
    extra: ['GENERAL'],
  ...
  },
  {
    ...
    rarity: 'RARE',
    set: 14,
    text: 'Stealth for 1 turn. After a friendly minion dies, give a minion in your hand +1/+1.',
    type: 'MINION',
    rating: 1,
    extra: ['GENERAL'],
  ...
  },
  {
    ...
    rarity: 'LEGENDARY',
    set: 14,
    text: 'Taunt, Lifesteal When you discard this, add 2 copies of it to your hand.',
    type: 'MINION',
    rating: 2,
    extra: ['GENERAL'],
  ...
  },
  {
    ...
    rarity: 'RARE',
    set: 14,
    text: 'Choose One - Give a minion +2/+4 and Taunt; or Summon two 3/2 Raptors.',
    type: 'SPELL',
    rating: 2,
    extra: ['BUFF', 'MIN_GEN'],
  ...
  },
  {
    ...
    cost: 6,
    dbfId: 50044,
    flavor: 'The Gurubashi Arena has an extremely permissive policy on pets in the workplace.',
    id: 'TRL_255',
  ...
  },
  {
    ...
    rarity: 'LEGENDARY',
    set: 14,
    text: 'Battlecry: Draw 1-Cost minions from your deck until your hand is full.',
    type: 'MINION',
    rating: 2,
  ...
  },
  {
    ...
    rarity: 'LEGENDARY',
    set: 14,
    text: "Divine Shield, Rush, Lifesteal  Costs (1) less for each Mana you've spent on spells.",
    type: 'MINION',
    rating: 2,
    extra: ['VALUE'],
  ...
  },
  {
    ...
    rarity: 'RARE',
    set: 14,
    text: 'Deal $4 damage to a minion. Costs (1) if you played an Elemental last turn.',
    type: 'SPELL',
    rating: 2,
    extra: ['SMALL_REMOVAL'],
  ...
  },
  {
    ...
    rarity: 'EPIC',
    set: 14,
    text: 'Deal $2 damage to all minions. Overkill: Add a random Mage spell to your hand.',
    type: 'SPELL',
    rating: 2,
    extra: ['AOE'],
  ...
  },
  {
    ...
    rarity: 'LEGENDARY',
    set: 14,
    text: 'Battlecry: Add a copy of your opening hand to your hand <i>(except this card)</i>.',
    type: 'MINION',
    rating: 3,
    extra: ['VALUE'],
  ...
  },
  {
    ...
    rarity: 'RARE',
    set: 14,
    text: 'Summon a random minion with Cost equal to your Armor <i>(up to 10).</i>',
    type: 'SPELL',
    rating: 1,
    extra: ['GENERAL'],
  ...
  },
  {
    ...
    set: 14,
    text: "Stealth for 1 turn. Your Rush minions are Immune the turn they're summoned.",
    type: 'MINION',
    rating: 3,
    extra: ['GENERAL'],
  ...
  },
  {
    ...
    cost: 2,
    dbfId: 50372,
    flavor: 'They say you can’t make an omelet without AHHH THEY’RE EATING MY FACE!',
    health: 2,
    id: 'TRL_503',
    mechanics: ['DEATHRATTLE'],
    name: 'Scarab Egg',
  ...
  },
  {
    ...
    rarity: 'RARE',
    set: 14,
    text: 'Taunt Battlecry: If your opponent has 2 or more minions, gain +1 Attack.',
    type: 'MINION',
    rating: 2,
    extra: ['GENERAL'],
  ...
  },
  {
    ...
    rarity: 'EPIC',
    set: 14,
    text: 'Whenever an adjacent minion takes damage, this  minion takes it instead.',
    type: 'MINION',
    rating: 1,
    extra: ['GENERAL'],
  ...
  },
  {
    ...
    dbfId: 50454,
    elite: true,
    flavor: 'ATTENTION: Do not enter any major city while infected with the Corrupted Blood!',
    health: 6,
    id: 'TRL_541',
    mechanics: ['DEATHRATTLE'],
  ...
  },
  {
    ...
    cardClass: ['PALADIN'],
    collectible: true,
    collectionText: "Battlecry: If you've restored 10 Health this game, gain +4/+4 and Taunt.",
    cost: 4,
    dbfId: 50514,
  ...
  },
  {
    ...
    text: "Battlecry: If you're holding a Dragon, deal 7 damage to an enemy minion.",
    type: 'MINION',
    rating: 3,
    extra: ['GENERAL'],
